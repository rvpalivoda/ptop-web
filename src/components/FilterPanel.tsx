      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        <div className="flex w-full gap-2 sm:w-auto">
          <input
            ...
            className="w-1/2 sm:w-24 bg-gray-700 border border-gray-600 rounded-md px-2 py-1 text-white placeholder-gray-400 focus:outline-none"
          />
        ...
        <div className="flex w-full sm:w-auto rounded-md overflow-hidden border border-gray-600">
          <button
            ...
            className={`w-1/2 sm:w-auto px-3 py-1 text-sm ${
